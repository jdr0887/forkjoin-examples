package com.kiluet.sieve.eratosthenes;
...
public class SOEParallel implements Runnable {
    ...
    public SOEParallel(final Integer ceiling) {
        super();
    ...
    public static void main(String[] args) {
        SOEParallel runnable = new SOEParallel(1000000000);
        runnable.run();
    }
