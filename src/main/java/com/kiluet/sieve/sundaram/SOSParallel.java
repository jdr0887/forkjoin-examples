package com.kiluet.sieve.sundaram;
...
public class SOSParallel implements Runnable {
    ...
    public SOSParallel(final Integer ceiling) {
        super();
    ...
    public static void main(String[] args) {
        SOSParallel runnable = new SOSParallel(100000000);
        runnable.run();
    }
